  ...
  <ul>
    ...
    <li id="page_SERVICES">
     ...
     <tr height="38"><td ><center>S.No</center></td> <td ><center>Group Member UserName</center></td> <td ><center>FileName</center></td><td ><center>FileType</center></td>
         <td ><center>FileSize</center></td> <td ><center>Uploaded Cost</center></td> <td ><center>Uploaded Date</center></td> <td ><center>Delete</center><td ><center>REVOKE</center></td></td></tr>
    <%
    DB Db=new DB(); 
...
<td><center><a href="Delete1.jsp?ff=<%=rs.getString("Fid")%>">DELETE</a></center></td><td><center><a href="Revoke.jsp?ff=<%=rs.getString("Fid")%>">REVOKE</a></center></td>
</tr>
