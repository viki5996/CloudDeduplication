...
<header>
  <a href="index.html" class="logo">    
    ...
    <div class="txt3">By Vikram and Harshita</div>
  </a>
</header>
   ...
   <ul id="menu">
    ...
    <li class="nav4">
      <a href="Audit.jsp#!/page_PARTNERS">
        <span class="over1"><span class="txt1">auditing process</span></span>
        <span class="over2"><img src="images/splash04.png" alt="" class="img"></span>
      </a>
    </li>
    <li class="nav5">
      <a href="#!/page_CONTACTS">
        <span class="over1"><span class="txt1">CONTACTS</span></span>
...
<article id="content">
  ...
  <ul>
    ...
    <div class="box3">
      ...
      <a href="#!/page_MORE" class="button1">New User Registration</a>    </div>
    </li>
    <!-- ============ PAGE SERVICES END============= -->
    ...
    <div class="box2">
      ...
      <div class="scroll-pane"><div>
        ...
        <div class="gal1">
          <div class="photo1"><a href="images/gallery01_big.jpg" rel="prettyPhoto[pp_gal1]" title="Photo Title"><img src="images/gallery01.jpg"></a></div>
          <div class="table">
            <p class="text upper color1">
              Suspendisse enim            </p>
            <p class="text">
              convallis non, cursus sed, dignissim et, est. Aenean            </p>
            <a href="#!/page_MORE" class="button1">more</a>          </div>
          <div class="clear"></div>
        </div>
        <div class="gal1">
          <div class="photo1"><a href="images/gallery02_big.jpg" rel="prettyPhoto[pp_gal1]" title="Photo Title"><img src="images/gallery02.jpg"></a></div>
          <div class="table">
            <p class="text upper color1">
              Suspendisse enim            </p>
            <p class="text">
        ...
        <div class="gal1">
          <div class="photo1"><a href="images/gallery03_big.jpg" rel="prettyPhoto[pp_gal1]" title="Photo Title"><img src="images/gallery03.jpg"></a></div>
          <div class="table">
            <p class="text upper color1">
              Suspendisse enim            </p>
            <p class="text">
        ...
        <div class="gal1">
          <div class="photo1"><a href="images/gallery04_big.jpg" rel="prettyPhoto[pp_gal1]" title="Photo Title"><img src="images/gallery04.jpg"></a></div>
          <div class="table">
            <p class="text upper color1">
              Suspendisse enim            </p>
            <p class="text">
        ...
        <div class="gal1">
          <div class="photo1"><a href="images/gallery05_big.jpg" rel="prettyPhoto[pp_gal1]" title="Photo Title"><img src="images/gallery05.jpg"></a></div>
          <div class="table">
            <p class="text upper color1">
              Suspendisse enim            </p>
            <p class="text">
        ...
        <div class="gal1 last">
          <div class="photo1"><a href="images/gallery06_big.jpg" rel="prettyPhoto[pp_gal1]" title="Photo Title"><img src="images/gallery06.jpg"></a></div>
          <div class="table">
            <p class="text upper color1">
              Suspendisse enim            </p>
            <p class="text">
    ...
    <div class="box2">
      ...
      <img src="images/partners04.jpg" alt="" class="border1 img3">
